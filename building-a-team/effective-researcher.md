...
From all this, we can extract a few lessons about how we should work as Applied Scientists.  Like I said earlier, it is about two things: caring about what we do and building a process around it.  Below are principles that put this into action. I don’t think that we should aim at devising a single process that works for everyone.  Each of us will find our own way of working.  But there are general principles that should guide us. 

 

 

1. Work on important problems.  The first thing we should do, as researchers, is to make sure that we are working on important problems. This is harder than it sounds.   

 

It means spending months on end on a given domain to understand the ins and outs of it, looking at the product, the business and the technology at the same time. Only when we do that do we get the big picture and understand what the important problems are.   

This also means never taking directions from others for granted.  Always look for data-based evidence.  This is about building a genuine understanding of what the scale of the problem is.  In case of missing evidence, you should always assume that a problem is not important.  

This also means regularly looking at production yourself, because this will give you a unique perspective on what the customers’ problems are.   

Finally, this also means developing genuine curiosity and asking why things are the way they are.   
...
2. Manage your most precious resource: time. Once you have found an important problem to work on, the next thing to do is to dedicate long periods of focus time on it.   

 

A good frame of reference is the maker’s schedule.   

I hear time and again people complain about interruptions or the lack of time for research.  This cannot be fixed without a ruthless approach to time management. If you ask me, I’ll say that having slack notifications turned on, as a researcher, is pure insanity.  You should turn off all notifications (at the exception, maybe, of the calendar, because, heck, it sucks to miss an important meeting).  Everything else should be turned off.  Every interruption costs you 25’ of context switching.  Do those 12 times a day.  You do the maths to guess what’s left for productive work.  

Now, some people will disagree and say: Slack is one of the few things that still connects me to my colleagues in this remote world.  That’s fair.  My point is: you should control slack, not the other way around. This advice about slack extends to everything that’s preventing you from getting into the flow.  Get your time back. 

 

 

3. Become agile in the code.  If you’re not agile in the code, you’re stuck under a glass ceiling.  You are restrained to pure experimentation with a high risk of things not panning out.  This does not mean being agile in production code.  

 

This means being able to hack things around. If you’re not at the right level, learn.  

If you don’t know where to start, look around for people who just did, and ask them how they did it.  
...
4. Learn to write effectively.  Doing great research is not enough.  You must convey your results effectively.   

 

This means simple things like writing simple executive summaries at the beginning (not the end) of a confluence page and making your work discoverable despite the dismal performance of the confluence search engine (i.e. name/organise your confluence pages properly).  

This also means targeting an audience that is not Applied Science.  Write for engineering, write for Product, write for the exec team. 90% of the work is Research. 

 

If you miss on the 10% of write-up, you get a 0% return. 

 

5. Optimize for adoption.  If you work alone on your project and everything goes well, you get a 1X return.  If you work with people who have leverage, you get a 10X return. What do I mean by people with leverage?  I mean people who can make your 1X turn into 10X for the company.  Here are a few examples (any resemblance to actual persons or events is totally intended).   

You’re building a new library for deep learning at Onfido. Six months down the road, 10 researchers are using it.  That’s leverage. 
...
3. Become agile in the code 
4. Learn to write effectively 
5. Optimize for adoption 


That’s it.  These are the principles that could turn us into outstanding researchers and improve the meaningfulness of our work.  Now go forth and do great Research! 
